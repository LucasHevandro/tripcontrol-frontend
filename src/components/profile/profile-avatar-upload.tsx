        ...
        <div className="flex items-center gap-4">
            <div className="relative">
                ...
                <button
                    ...
                    className="absolute bottom-0 right-0 flex h-7 w-7 items-center justify-center rounded-full border-2 border-white bg-neutral-900 text-white hover:bg-neutral-700 dark:border-neutral-900 dark:bg-neutral-100 dark:text-neutral-900 dark:hover:bg-neutral-200"
            ...
            <div>
                ...
                <p className="text-xs text-neutral-400 dark:text-neutral-500">JPG ou PNG, até 5MB</p>
            </div>
        </div>
    );
}